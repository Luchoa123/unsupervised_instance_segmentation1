...
annota = json.load(open('/home/cuonghoang/Desktop/codedict/RNCDL-main/dataset/lvis/lvis_v1_train.json'))
...
def show_result_ins(img,
    ...
    for i in [1,2]:
        ...
        for idx in range(num_mask):
            ...
            # ban=['cabinet','envelope','newspaper','toaster_oven','magazine','drawer','timer'] #,'bathtub','cabinet'
            # allow=['9cabinet','3cabinet']

            # ban=['bathrobe','drawer','knob','bath_mat','bathtub','cabinet','water_faucet','doormat'] #,'bathtub','cabinet'
            # allow=['5bathtub','2cabinet']

            ##44039##
            # ban=['trash_can','heater','washbasin','faucet','gargle','envelope','beer_can','shovel','mop','broom','razorblade','bathrobe','shampoo','cleansing_agent','shaving_cream','aerosol_can','sink'] #,'bathtub','cabinet'
            # allow=['5bathtub','2cabinet','7sink','13sink','8bathrobe','12aerosol_can']


            ##76417##
            # ban=['puppy','dog'] #,'bathtub','cabinet'
            # allow=[]

            # ##000000092331##
            # ban=['clothes_hamper','slipper_(footwear)','drawer','blackboard','box','radio_receiver','clothes_hamper','garbage','globe','thread','beanbag','cracker','handbag','card','carton'] 
           
            # allow=[]

            ##000000065484##
            ban=['pipe','candle','chopping_board','canister','cistern','mixer_(kitchen_tool)','water_heater','vat','book','hammer','measuring_cup','Dixie_cup','drum_(musical_instrument)','birthday_card','saucepan','box','crock_pot','food_processor','dish','mug','timer','thermometer','microwave_oven','kettle','can','toaster_oven','ladle','wrench','grater','potholder','water_cooler','teakettle','ashtray','yogurt','handle','drawer'] 
            
           
            allow=['20drawer','16drawer','70handle','40yogurt']


            if i==1:
                print(label_text)
            if label_text1 not in ban:
            #         label_text='spoon'
                
                # if label_text1=='aerosol_can':
                #     label_text1='painting'

                # if label_text1=='air_conditioner':
                #     label_text1='chair'

                # if label_text1=='kitchen_sink':
                #     label_text1='sink'

                # if label_text1=='aerosol_can':
                #     label_text1='bathtub'

                # if label_text1=='runner_(carpet)':
                #     label_text1='carpet'

                # if label_text1=='hook':
                #     label_text1='spoon'

                # if label_text1=='shower_curtain':
                #     label_text1='curtain'
                
                # if label_text1=='water_faucet':
                #     label_text1='faucet'

                

                ##000000076417##
                # dict1={'aerosol_can':'rearview_mirror','air_conditioner':'car','airplane':'dog'}
                
                pos_x=0
                pos_y=0

                ##000000092331##
                # dict1={'alarm_clock':'mirror','television_set':'television','aerosol_can':'ashtray','almond':'table','alcohol':'pizza','alligator':'box','potholder':'hat','bowling_ball':'hat','air_conditioner':'drawer','airplane':'handle'}
                ...
                ##000000065484##
                dict1={"apricot":"teakettle",'almond':"wall_socket",'ambulance':"meat_grinder",'amplifier':'scale','washbasin':'measurement','aerosol_can':'dispenser','antenna':'case_shot','jar':'can','beer_can':'can','apple':'bottle','air_conditioner':'ladle','anklet':'calender','airplane':"utensil",'alcohol':'turner','alarm_clock':'scissors','sharpener':'fork','carton':'can','alligator':'table','applesauce':'opener','pot':'boiler'}
                try:
...
# a69 = json.load(open('/home/cuonghoang/Desktop/codedict/RNCDL-main/dataset/lvis/lvis_v1_val.json'))['images']
# ann=a['annotations']
...
# coco1 = COCO("/home/cuonghoang/Downloads/labels_my-project-name_2024-01-16-02-18-49.json")  #000000006213

# coco1 = COCO("/home/cuonghoang/Downloads/labels_000000499480_2024-01-16-02-36-12.json") #000000499480

# coco1 = COCO("/home/cuonghoang/Downloads/labels_my-project-name_2024-04-14-12-18-54.json") #000000076417

# coco1 = COCO("/home/cuonghoang/Downloads/labels_my-project-name_2024-04-12-11-41-22.json") #000000044039

# coco1 = COCO("/home/cuonghoang/Downloads/labels_my-project-name_2024-04-14-12-23-12.json") #000000092331

# coco1 = COCO("teaser_mask.json") #000000065484
coco1 = COCO("teaser_coarse.json")


# coco = COCO("/home/cuonghoang/Desktop/codedict/RNCDL-main/dataset/lvis/lvis_v1_val.json")
list_id=set()
...
name='ILSVRC2012_val_00008229.JPEG'  #000000499480  000000006213  000000044039.jpg  000000076417  000000092331  000000065484
# for l in a69:
